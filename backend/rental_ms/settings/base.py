...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"model": "carwash.Appointment"},
        {"app": "carwash"},
    ],
    "search_model": ["carwash.Appointment"],
    ...
    "icons": {
        ...
        "carwash.Branch": "fas fa-building",
        "carwash.Service": "fas fa-car",
        "carwash.VehicleCategory": "fas fa-car-side",
        "carwash.Appointment": "fas fa-calendar-check",
